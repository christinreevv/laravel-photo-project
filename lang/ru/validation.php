...
return [
    ...
    */
    ...
    'max' => [
        ...
        'string' => 'Пароль не может превышать :max символов.',
    ],
    ...
    'required_if' => 'Поле :attribute обязательно, если :other не находится в :values.',
    ...
    */
    ...
    'attributes' => ['title'=>'Имя', 'description'=> 'Описание', 'email'=> 'почта'],
