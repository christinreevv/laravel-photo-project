...
CREATE TABLE `Customers` (
  `cust_id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cust_name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cust_address` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_city` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_state` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_zip` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_country` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_contact` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_email` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
(14, '2024_10_28_104029_create_goods_table', 1),
(15, '2024_10_28_113901_create_quantity', 1),
(17, '2024_10_28_114341_rename_table_goods', 2),
(18, '2024_10_28_114603_quantity_100_default', 2),
(19, '2024_10_28_112655_create_goods_table', 3),
(20, '2024_11_11_082020_create_posts_table', 3);
...
CREATE TABLE `OrderItems` (
  ...
  `prod_id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(20005, 10, 'BR03', 111, '111.00'),
(20005, 1122, 'BR03', 11, '111.00'),
(20005, 11111, 'BR03', 11, '111.00'),
(20006, 1, 'BR01', 20, '5.99'),
(20006, 2, 'BR02', 10, '8.99'),
(20006, 3, 'BR03', 10, '11.99'),
(20006, 10, 'BR03', 111, '111.00'),
(20006, 10111, 'BR01', 111, '111.00'),
...
INSERT INTO `photos` (`id`, `title`, `created_at`, `update_time`, `description`, `path`) VALUES
(4, 'relationship', '2024-11-25 08:19:00', '2024-11-25 08:19:00', 'The love of two young people', 'img\\gray_1.jfif'),
(5, 'palm', '2024-11-25 08:20:05', '2024-11-25 08:20:05', 'Beautiful palm tree by the sea', 'img\\gray_2.jfif'),
(7, 'silhouette', '2024-11-25 08:29:11', '2024-11-25 08:29:11', 'The silhouette of a young man', 'img\\gray_4.jfif'),
(8, 'woman', '2024-11-25 08:29:48', '2024-11-25 08:29:48', 'The girl looks through the object', 'img\\gray_3.jfif');
...
(1, 'popopo', 'lokoko', NULL, NULL, 1),
(2, 'trtr', 'rtrtr', NULL, NULL, 1);
...
CREATE TABLE `Products` (
  `prod_id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vend_id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prod_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prod_price` decimal(8,2) NOT NULL,
  `prod_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `reviews` (`id`, `post_id`, `text`, `created_at`, `updated_at`) VALUES
(1, 1, 'Первый текст', '2024-11-18 11:23:10', '2024-11-18 11:23:10'),
(2, 2, 'Второй текст', '2024-11-18 11:23:10', '2024-11-18 11:23:10'),
(3, 3, 'Третий текст', '2024-11-18 11:23:10', '2024-11-18 11:23:10');
...
INSERT INTO `rubrics` (`id`, `name`, `description`) VALUES
(1, 'popo', 'opop'),
(2, 'okok', 'koko'),
(3, 'omom', 'nono');
...
--
-- Дамп данных таблицы `sad`
--

INSERT INTO `sad` (`id`, `title`, `description`, `price`, `created_at`, `updated_at`, `quantity`) VALUES
(1, 'Барабан', 'Замечательный музыкальный инструмент', 2500.00, NULL, NULL, 100),
(2, 'Флаг', 'Полезная вещь для размахивания им', 1700.00, NULL, NULL, 100),
(3, 'WxT7cDKleM', 'AKIjsgOfJi1y7Gac1y4EBWS8ZUTWsxuhEXxyQNrC1C1Uf9RkHw', 5024.00, NULL, NULL, 100),
(4, 'koy7lUHSuY', 'yjKZlPaUuzzIf19y1Bzs7emCDr0uaPclIq2AushX1SERDvv0Po', 2541.00, NULL, NULL, 100),
(5, 'NbPMUjYwRq', 'ec5jMo49LxGlNhlckZcJ77UZittw3Rqe4SS9cwpAysQY1BBnKC', 5976.00, NULL, NULL, 100),
(6, 'Mf12nrIFwH', 'vjxp9VprZZhOOgQj826pjNUA1hEHFzrnSqMoCDwHUAvb0z7Vdn', 9013.00, NULL, NULL, 100),
(7, 'BR9X1vGIdj', '3GtK694CCt8NntIJ1ZhavJKJFlu7eaS5k8zGY7caHvTh65j4CS', 7690.00, NULL, NULL, 100),
(8, '8dZQphPIuO', 'cNxiRMXf7shBB90PbOa41rtBw8AmGC7DRBbWlrgZQ621XYHDDG', 680.00, NULL, NULL, 100),
(9, 'YA5nIsvy41', 'IXSIb8kHx9XuJS5CCNN6tVEyTcSsmnKt3FoXyOmbNnNrpt7Sig', 6998.00, NULL, NULL, 100);
...
(1, 'dddd', 'dasas@gmail.com', NULL, '$2y$12$RBbSXba.uV1KRwXfwjoYb.raA.QyeSoR.9RmO5yU0v0uVkfvvBLA2', NULL, NULL, NULL),
(2, 'Влада', 'vlada6256@gmail.com', NULL, '$2y$12$JZp2Vqu9bK5RYXONVCr62OpsMRd/Ao6qyBb7yvom49vclZzwXZ.Zq', NULL, NULL, NULL),
(3, 'li', 'li@gmail.com', NULL, '$2y$12$5t23m0x2z7s4NMJQ4jXpzu9acycCUaVGJEFwN7auBul5gps1HVYAO', NULL, '2024-11-25 08:25:08', '2024-11-25 08:25:08'),
(4, 'lia', 'lia@gmail.com', NULL, '$2y$12$J5D0AnOe0THxux7ahoc0Aum.WQGBCnj1N4EiAwwImnJA01FMUhbNS', NULL, '2024-11-25 08:26:13', '2024-11-25 08:26:13');
...
CREATE TABLE `Vendors` (
  `vend_id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vend_name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vend_address` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vend_city` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vend_state` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vend_zip` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vend_country` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- AUTO_INCREMENT для таблицы `sad`
--
ALTER TABLE `sad`
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`rubric_id`) REFERENCES `rubrics` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`id`) REFERENCES `reviews` (`post_id`) ON DELETE CASCADE;
